...
public class Main {
    ...
    public static final String MOD_ID = "locomotionmobs";
    ...
    private void enqueueIMC(final InterModEnqueueEvent event)
    {
        ...
        InterModComms.sendTo("locomotionmobs", "helloworld", () -> { LOGGER.info("Hello world from the MDK"); return "Hello world";});
    }
